...
thread1 = threading.Thread(target=crearAnimacion,args=(10,10,"X"))
thread2 = threading.Thread(target=crearAnimacion,args=(10,30,"Y"))
thread3 = threading.Thread(target=crearAnimacion,args=(10,50,"Z"))
